    ...
    * ------------------------------------------------------ */
    const ssContactForm = function() {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const csrfTokenElement = contactForm.querySelector('[name=csrfmiddlewaretoken]');
            if (!csrfTokenElement) {
                showFormMessage('Security token not found. Please refresh the page and try again.', 'error');
